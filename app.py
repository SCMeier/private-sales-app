...
st.write("Upload your Private Sales CSV file below:")
        ...
        if "event_ref_data" not in st.session_state:
            ...
            if missing_events:
                add_df = pd.DataFrame({
                    ...
                    "Sales Date": ["" for _ in missing_events],
                })
